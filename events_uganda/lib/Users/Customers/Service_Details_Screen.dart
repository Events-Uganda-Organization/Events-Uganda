    ...
    children: [
      ...
      Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(Icons.outdoor_grill, color: Colors.black, size: 20),
              SizedBox(width: 8),
              Text(
                'Outside Catering',
                style: TextStyle(
      ...
      SizedBox(width: 30), // space before divider
      ...
      SizedBox(width: 30), // space after divider
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.food_bank_rounded, color: Colors.black, size: 20),
                SizedBox(width: 8),
                Text(
                  'Buffet Setup',
                  style: TextStyle(
            ...
            Row(
              children: [
                Icon(Icons.soup_kitchen, color: Colors.black, size: 20),
                SizedBox(width: 8),
                Text(
                  'Traditional Food',
                  style: TextStyle(
