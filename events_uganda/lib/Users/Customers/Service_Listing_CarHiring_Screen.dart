...
class ServiceListingCarHiringScreen extends StatefulWidget {
  ...
  const ServiceListingCarHiringScreen({
    super.key,
    this.category,
    this.categoryIndex,
  });
  @override
  State<ServiceListingCarHiringScreen> createState() =>
      _ServiceListingCarHiringScreenState();
}

class _ServiceListingCarHiringScreenState extends State<ServiceListingCarHiringScreen>
