...
class ServiceListingDecorationScreen extends StatefulWidget {
  ...
  const ServiceListingDecorationScreen({
    super.key,
    this.category,
    this.categoryIndex,
  });
  @override
  State<ServiceListingDecorationScreen> createState() =>
      _ServiceListingDecorationScreenState();
}

class _ServiceListingDecorationScreenState extends State<ServiceListingDecorationScreen>
