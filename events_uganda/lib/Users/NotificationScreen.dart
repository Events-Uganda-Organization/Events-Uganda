                      ...
                      child: SingleChildScrollView(
                        ...
                        Padding(
                          ...
                          child: _buildDismissibleCard(
                            key: const ValueKey('today_card_1'),
                        ...
                        Padding(
                          ...
                          child: _buildDismissibleCard(
                            key: const ValueKey('today_card_2'),
                            screenWidth: screenWidth,
                            child: Container(
                              width: double.infinity,
                              height: screenWidth * 0.19,
                        ...
                        Padding(
                          ...
                          child: _buildDismissibleCard(
                            key: const ValueKey('yesterday_card_1'),
                            screenWidth: screenWidth,
                            child: Container(
                              width: double.infinity,
                              height: screenWidth * 0.19,
                                ...
                                children: [
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      height: screenWidth * 0.128,
                                      decoration: BoxDecoration(
                                        color: const Color(0xFF96E8F4).withValues(alpha: 0.5),
                                        shape: BoxShape.circle,
                                      ),
                                      child: Center(
                                        child: Icon(
                        ...
                        Padding(
                          ...
                          child: _buildDismissibleCard(
                            key: const ValueKey('yesterday_card_2'),
                            screenWidth: screenWidth,
                            child: Container(
                              width: double.infinity,
                              height: screenWidth * 0.19,
                        ...
                        Padding(
                          ...
                          child: _buildDismissibleCard(
                            key: const ValueKey('yesterday_card_3'),
                            screenWidth: screenWidth,
                            child: Container(
                              width: double.infinity,
                              height: screenWidth * 0.19,
